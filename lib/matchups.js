...
/**
 * Matchup cards for past / current gameweek
 * @param {*} matchesForViewedGameweek matchups filtered to the current viewed gameweek
 * @param {*} tableData the table data for the league
 * @param {*} isCurrentGameweek true if the selected gameweek is the current one
 * @param {*} matchesForPastGameweeks matchups data for all past gameweeks
 * @returns matchups cards if the selected gameweek is in the past (or current)
 */
// TODO: Refactor some of this into a helper function.
...
/**
 * Matchup cards for future gameweeks
 * @param {*} matchesForViewedGameweek matchups for the currently selected gameweek
 * @param {*} allMatchups matchups data for all past gameweeks
 * @param {*} tableData table data for the selected league
 * @returns matchups cards if the selected gameweek is in the future
 */
 ...
 * @param {*} isFinished is current gameweek finished
 * @param {*} allMatchups all matchups for the current league
 * @param {*} otherMatchups all matchups for the other league
 * @param {*} tableData table data for the current league
 * @param {*} cupData cup data if applicable (or null)
 * @returns Matchups component that displays all matchups for a gameweek
 */
