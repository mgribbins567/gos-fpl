import { ELEMENT_TYPE, mergeTeamWithLiveData } from "./fplData";
...
export function resolvePlayersForGameweek(
  rows,
  bootstrap,
  live,
  { autoSub = false } = {},
  ...
  return autoSub ? applyAutoSubstitutions(merged).players : merged;
}
