  ...
  return (
    <Layout about>
      <div className={utilStyles.main}>
        ...
        <div className={utilStyles.about}>
          If you'd like to contact me, feel free to message me on Discord,
          email, or text me! I'd be more than happy to chat about anything I've
          written here or answer any questions you may have.
        </div>
      </div>
    </Layout>
  );
